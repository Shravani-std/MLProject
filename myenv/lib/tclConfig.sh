...
# installed.
TCL_PREFIX='/media/shrav/New Volume/projects/ML_project/myenv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/media/shrav/New Volume/projects/ML_project/myenv'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /media/shrav/New Volume/projects/ML_project/myenv/include -fdebug-prefix-map=/croot/tk_1755243777296/work=/usr/local/src/conda/tk-8.6.15 -fdebug-prefix-map=/media/shrav/New Volume/projects/ML_project/myenv=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /media/shrav/New Volume/projects/ML_project/myenv/include'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/media/shrav/New Volume/projects/ML_project/myenv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/media/shrav/New Volume/projects/ML_project/myenv/include'
...
TCL_PACKAGE_PATH='/media/shrav/New Volume/projects/ML_project/myenv/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/media/shrav/New Volume/projects/ML_project/myenv/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1755243777296/work/tcl8.6.15/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/media/shrav/New Volume/projects/ML_project/myenv/lib/libtclstub8.6.a'
